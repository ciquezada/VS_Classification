...
# python ../monitoring/send_email.py "adapter_Ks_metalicity.py INICIADO" "VVVx short period metallicity"
...
# python ../monitoring/send_email.py "adapter_Ks_metalicity.py TERMINADO" "Se crearon todos los archivos"
