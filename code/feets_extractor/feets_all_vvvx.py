...
#    data_path = cwd + os.sep  + ".." + os.sep + "datos_all_vvvx" + os.sep + "cep_sel112434_vvvx" + os.sep
#    data_path = cwd + os.sep  + ".." + os.sep + "datos_all_vvvx" + os.sep + "sel_rrab_vvvx_74476" + os.sep
    data_path = cwd + os.sep  + ".." + os.sep + "datos_all_vvvx" + os.sep + "rrab_sel445198_vvvx" + os.sep
    ...
    features = pd.DataFrame(data, columns= ["filename", "period"] + selected_features)
    return features
...
def extractor_worker(arg):
    ...
    if not set(selected_features).isdisjoint(gp_dependent_features):
        params["FitGP"] = {"period": min_aov, "gamma": 0.1}
    ...
    if not set(selected_features).isdisjoint(fcomponents_dependent_features):
        params["FitFourier"] = {"period": min_aov, "gamma": 0.1}
